...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    CGRect frame = CGRectMake(0, HEIGHT-40, WIDTH, 40);
    ...
    if (self) {
        ...
        self.btnSendMessage.frame = CGRectMake(WIDTH-40, 5, 30, 30);
        ...
        self.btnVoiceRecord.frame = CGRectMake(70, 5, WIDTH-70*2, 30);
        ...
        //输入框
        self.TextViewInput = [[UITextView alloc]initWithFrame:CGRectMake(45, 5, WIDTH-2*45, 30)];
